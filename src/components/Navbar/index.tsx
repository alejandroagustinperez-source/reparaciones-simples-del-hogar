...
function FacebookIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block', flexShrink: 0 }} shapeRendering="geometricPrecision">
    ...
    <nav className={styles.navbar}>
      <div className={styles.inner}>
        <Link href="/" className={styles.logo} onClick={handleLinkClick}>
          <span className={styles.logoWrench}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>
            </svg>
          </span>
          <span style={{ display: 'flex', flexDirection: 'column', lineHeight: '1.3' }}>
            <span className={styles.logoTextNavy}>Reparaciones Simples</span>
            <span className={styles.logoTextOrange}>del Hogar</span>
          </span>
